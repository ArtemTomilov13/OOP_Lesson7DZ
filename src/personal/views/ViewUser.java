...
public class ViewUser {
    ...
    private void deleteUser() {
        String readId = getID("Введите ID заметки для удаления: ");
        userController.deleteUser(readId);
    }

    private void updateUser() throws Exception {
        String readId = getID("Введиет редактируемый ID заметки: ");
    ...
    private void readUser() throws Exception {
        String id = getID("Идентификатор заметки: ");
    ...
    private User inputUser() {
        ...
        String phone = prompt("Примечание: ");
